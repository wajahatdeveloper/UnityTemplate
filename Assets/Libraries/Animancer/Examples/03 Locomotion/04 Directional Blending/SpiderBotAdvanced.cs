...
namespace Animancer.Examples.Locomotion
{
    ...
    /// </summary>
    [AddComponentMenu("Animancer/Examples/Locomotion - Spider Bot Advanced")]
    ...
    public sealed class SpiderBotAdvanced : MonoBehaviour, IAnimancerClipSource
    {
        ...
        [SerializeField] private AnimationClip _WakeUp;
        [SerializeField] private MixerState.Serializable2D _Locomotion;
        [SerializeField] private float _AnimationAcceleration = 3;
