...
namespace Animancer.Examples.Basics
{
    ...
    /// </summary>
    [AddComponentMenu("Animancer/Examples/Basics - Sequence Coroutine")]
    ...
    public sealed class SequenceCoroutine : MonoBehaviour
    {
        ...
        public class SequenceClip : ClipState.Serializable
        {
            ...
            [SerializeField, Tooltip("Determines how long this animation will play for during the sequence" +
        ...
        [SerializeField] private SequenceClip[] _Animations;
