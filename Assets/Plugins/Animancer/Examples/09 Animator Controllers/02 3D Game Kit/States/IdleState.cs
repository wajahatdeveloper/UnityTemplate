...
namespace Animancer.Examples.AnimatorControllers.GameKit
{
    ...
    /// </summary>
    [AddComponentMenu("Animancer/Examples/Game Kit - Idle State")]
    ...
    public sealed class IdleState : CreatureState
    {
        ...
        [SerializeField] private ClipState.Serializable _MainAnimation;
        ...
        [SerializeField] private ClipState.Serializable[] _RandomAnimations;
        ...
        private void Awake()
        {
            ...
            for (int i = 0; i < _RandomAnimations.Length; i++)
            {
                ...
                // delegate object for each animation. This way all animations just use the same object.
            }
        }
        ...
        private void PlayMainAnimation()
        {
            ...
            Creature.Animancer.Transition(_MainAnimation);
        }
        ...
        private void FixedUpdate()
        {
            ...
            if (Creature.Animancer.CurrentState == _MainAnimation.State &&
                Creature.Animancer.CurrentState.Time >= _RandomizeTime)
            {
                PlayRandomAnimation();
            }
        }
        ...
        private void PlayRandomAnimation()
        {
            ...
            Creature.Animancer.Transition(animation);
        }
