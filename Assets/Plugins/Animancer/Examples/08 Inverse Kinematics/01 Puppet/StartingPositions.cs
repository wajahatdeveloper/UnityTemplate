...
namespace Animancer.Examples.InverseKinematics
{
    ...
    /// </summary>
    [AddComponentMenu("Animancer/Examples/Inverse Kinematics - Starting Positions")]
    [HelpURL(Strings.APIDocumentationURL + ".Examples.InverseKinematics/StartingPositions")]
