...
namespace Animancer.Examples.AnimationEvents
{
    /// <summary>
    /// An example of how to use the <see cref="SimpleEventReceiver.onEvent"/> callback.
    /// </summary>
    [AddComponentMenu("Animancer/Examples/Animation Events - Golf Hit Controller")]
